...
break
 ...
 case 'otak':
    capt `*Palabras especificas para que el bot interactue con ustedes mis queridos otakus*
...
`)
		...
		if (budy.includes(`Buenos dias`)) {
                  m.reply(`Buenos Dias trolos de mierda`)
                  }

		if (budy.includes(`hola`)) {
                  m.reply(`hola querida`)
                  }
